...
SUBCODES = {
    ...
    "02": {
        ...
        "notes": "Please use other (sub 02 only) LBS monthly report to"
        " track the allocations and expenditures",
    },
    "03": {"title": "Supplies and Expense", "notes": "Includes travel"},
    "04": {"title": "Equipment and Facilities", "notes": ""},
    "05": {"title": "Books/Collections", "notes": ""},
    "06": {
        "title": "Employee Benefits",
        "notes": "19900 benefits will be funded from the Library Reserve account at year end",
    },
    "07": {"title": "Special Items", "notes": ""},
    "08": {"title": "Unallocated Funds", "notes": ""},
    "09": {"title": "Recharges and Departments", "notes": ""},
    "9H": {"title": "Overhead (F&A)", "notes": "Apply to Contracts and Grants"},
}
